...
print("___________________________zap.lua__________________________")
print("| [zap.lua] Executed version: 6.0")
...
print("| [zap.lua] Made by ekso <@804245361894883339>     ")
...
WhitelistSection:AddToggle('Enable Whitelist', false, function(State)
...
local tracersToggle = EspSector:AddToggle("Enable Tracers", false, function(bool)
    ESP.Tracers = bool
end)

local namesToggle = EspSector:AddToggle("Enable Names", false, function(bool)
    ESP.Names = bool
end)

local boxesToggle = EspSector:AddToggle("Enable Boxes", false, function(bool)
    ESP.Boxes = bool
end)
...
local CashSector = BlatantTab:CreateSector("Auto Drop", "left")
...
local AutoSetTab = TeleportTab:CreateSector("Buy Set", "right")
