...
local Window = Library:CreateWindow("hoodsense", Vector2.new(550, 500), Enum.KeyCode.RightShift)
...
Notify({
    Title = "hoodsense",
    Description = "Noclip Keybind is B!",
    Duration = 3
})
end)
...
local macro = MiscSection:AddButton("Fake Macro", function(State)
    Notify({
        Title = "hoodsense",
        Description = "Macro Keybind is Z!",
        Duration = 3
    })
...
local god = MiscSection:AddButton("God Mode", function(State)
    ...
    Notify({
        Title = "hoodsense",
        Description = "This can't be stopped.",
        Duration = 3
    })
end)
...
local superjump = scriptsSection:AddButton("Super Jump", function()
    ...
    Notify({
        Title = "hoodsense",
        Description = "Super jump Keybind is H!",
        Duration = 3
    })
end)
...
local partners1 = partnersSection:AddButton("discord.gg/zp", function(bool)
    setclipboard("https://discord.gg/zp")
    Notify({
        Title = "hoodsense",
        Description = "Supporter copied on clipboard!",
        Duration = 3
    })
end)
